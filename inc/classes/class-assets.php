...
class Assets {
  ...
  public function register_styles() {
    ...
    // Front-end UI overrides (loaded AFTER the base styles to win specificity)
    wp_enqueue_style( 'copycats_front_ui', COPYCATS_THEME_URI . '/assets/css/copycats-front-ui.css', array( 'template_css', 'copycats_layout' ), '1.0.0', 'all' );
  ...
  public function register_scripts() {
    ...
    wp_enqueue_script( 'coppycats_app', COPYCATS_THEME_URI . '/assets/js/app.js', array('jquery'), $version, true );
		wp_enqueue_script( 'copycats_front_ui', COPYCATS_THEME_URI . '/assets/js/copycats-front-ui.js', array('jquery'), '1.0.0', true );
