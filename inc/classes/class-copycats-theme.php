...
class COPYCATS_THEME {
	...
	public function setup_theme() {
		...
		add_image_size( 'shop_catalog', 250, 250, true );
	...
	function copycats_main_slider() {
		...
		$slides = array(
			...
			'slide_2'	=> array(
										...
										'slide_excerpt'	=>	'Conoce nuestro catálogo de <strong>Materiales para construcción</strong>',
										'slide_link'		=> 	'',
		...
		foreach ( $slides as $slide ) {
			$html_content	.= 	'<div class="carousel-item' . ( $is_first ? ' active' : '' ) . '">';
			...
			if (!empty($slide['slide_link'])){
				$html_content .=	'<a class="btn-cc-cta mt-3" href="' . $slide[ 'slide_link' ] . '">Visitar</a>';
			}
