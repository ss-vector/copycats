<?php
/**
 * Copycats Projects Section Template
 *
 * @package Copycats
 * @since 1.3.7
 */
...
<div class="content-grid container">
    ...
    <?php
    if ($page_query_featured->have_posts()):
        while ($page_query_featured->have_posts()):
            $page_query_featured->the_post(); ?>

    <div class="featured-card large-block p-4 p-md-5 mb-4 mt-3 rounded" style="background: url(<?php echo get_the_post_thumbnail_url(
        get_the_ID(),
        "large",
    ); ?>);">
      <div class="featured-content col-lg-6 px-0">
          <!--href="<?php echo esc_url(get_permalink()); ?>"-->
            <div <?php post_class(); ?>>
              ...
              if (!empty($categories)) {
                  echo '<span class="tag d-inline-block text-white">' .
    ...
    <div class="row mb-2">
      ...
      <?php
      if ($page_posts_feed->have_posts()):
          while ($page_posts_feed->have_posts()):
              $page_posts_feed->the_post(); ?>
            ...
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
              <div class="col d-flex flex-column position-static">
                ...
                <span class="newsletter-categories">
                  ...
                  $categories = get_the_category($post->ID);
                  if (!empty($categories)) {
                      echo '<strong class="tag d-inline-block text-white">' .
                          esc_html($categories[0]->cat_name) .
                          "</strong>";
                  }
                  ?>
